pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/justinjoallen/metallb-deploy'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('allenjj2-225-sp26')   // <---- Change this to match your kubernetes cluster credentials
    }
